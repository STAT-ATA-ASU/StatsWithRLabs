...
<div id="exercise">
**Exercise**: Calculate 100 confidence intervals at the 99% confidence level.  Plot all intervals and calculate the proportion of intervals that include the true population mean.
</div>
```{r plot-99-perc-cis, fig.height=7}
# type your code for the Exercise here, and Knit
