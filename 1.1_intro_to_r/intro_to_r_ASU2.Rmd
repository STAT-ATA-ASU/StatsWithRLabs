...
female christenings (births) in London from 1629 to 1710.  
You should see that the workspace 
...
<div id="exercise">
**Exercise**: What years are included in this dataset? Hint: Take a look at the
...
```{r plot-girls-vs-year, fig.cap = "Total number of girls baptized by year"}
...
```{r plot-total-vs-year-line, fig.cap= "Total number of baptisms per year"}
...
<div id="exercise">
**Exercise**: Create a plot of the proportion of boys born over time. What 
do you see? 
</div>
